	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(16, 31)
						.addBox(-2.5F, -6.0F, -3.5F, 5.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 37)
						.addBox(-1.0F, -3.0F, -7.5F, 2.0F, 1.0F, 4.0F, new CubeDeformation(-0.025F)),
				PartPose.offset(0.0F, 14.0F, -2.75F));

		PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(4, 21).addBox(-0.5F, -0.5F, -7.6F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -4.0F, -0.5F, 0.1309F, 0.0F, 0.0F));
