...
public class Modelblue_whale<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "blue_whale"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition jaw = body.addOrReplaceChild("jaw",
				CubeListBuilder.create().texOffs(0, 177)
						.addBox(-18.0F, 0.0F, -59.0F, 36.0F, 33.0F, 60.0F, new CubeDeformation(0.0F)).texOffs(192, 177)
						.addBox(-17.0F, -4.0F, -58.5F, 34.0F, 33.0F, 58.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -16.0F, -40.0F));

		PartDefinition finleft = body.addOrReplaceChild("finleft",
				CubeListBuilder.create().texOffs(20, 26).addBox(-1.0F, -2.0F, -8.0F, 2.0F, 26.0F, 16.0F,
		...
		PartDefinition finright = body.addOrReplaceChild("finright",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -2.0F, -8.0F, 2.0F, 26.0F, 16.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-21.0F, 24.0F, -29.0F, 0.0F, 0.0F, 0.7854F));

		PartDefinition tail = partdefinition.addOrReplaceChild("tail",
				CubeListBuilder.create().texOffs(215, 68)
