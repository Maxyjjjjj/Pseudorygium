...
public class Modelwaterbuck<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "waterbuck"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0)
				.addBox(-3.0F, -5.0F, -7.0F, 8.0F, 8.0F, 14.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-1.0F, 10.0F, 0.0F));

		PartDefinition head = body.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 22)
						.addBox(-3.0F, -12.0F, -1.0F, 6.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(38, 0)
						.addBox(-2.0F, -10.0F, -4.0F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(1.0F, -1.0F, -7.0F));

		PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(0.0F, -21.0F, 0.5F, 2.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(38, 6)
						.addBox(5.0F, -11.0F, 0.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.2618F));

		PartDefinition cube_r2 = head.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(30, 0)
						.addBox(-2.0F, -21.0F, 0.5F, 2.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(36, 10)
						.addBox(-8.0F, -11.0F, 0.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.2618F));

		PartDefinition legleftfront = partdefinition.addOrReplaceChild("legleftfront", CubeListBuilder.create()
				.texOffs(12, 39).addBox(-2.0F, 0.0F, -1.0F, 3.0F, 14.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(2.5F, 10.0F, -5.0F));

		PartDefinition legrightfront = partdefinition.addOrReplaceChild("legrightfront", CubeListBuilder.create()
				.texOffs(0, 38).addBox(-2.0F, 0.0F, -1.0F, 3.0F, 14.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-1.5F, 10.0F, -5.0F));

		PartDefinition legrightback = partdefinition.addOrReplaceChild("legrightback", CubeListBuilder.create()
				.texOffs(32, 22).addBox(-2.0F, 0.0F, -1.0F, 3.0F, 14.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition legleftback = partdefinition.addOrReplaceChild("legleftback", CubeListBuilder.create()
				.texOffs(20, 22).addBox(-2.0F, 0.0F, -1.0F, 3.0F, 14.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(2.5F, 10.0F, 4.0F));
