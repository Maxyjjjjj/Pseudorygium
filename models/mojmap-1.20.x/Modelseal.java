...
public class Modelseal<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "seal"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition neck = body.addOrReplaceChild("neck",
				CubeListBuilder.create().texOffs(26, 31)
						.addBox(-4.0F, -2.0F, -8.0F, 8.0F, 6.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(36, 5)
						.addBox(-2.5F, 1.0F, -10.0F, 5.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
