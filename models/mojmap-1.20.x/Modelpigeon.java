...
public class Modelpigeon<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "pigeon"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = neck.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(24, 0)
						.addBox(-2.5F, -2.0F, -3.0F, 5.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 7)
						.addBox(-1.0F, 0.0F, -5.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
