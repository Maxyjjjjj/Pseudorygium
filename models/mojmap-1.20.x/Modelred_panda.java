	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 17)
						...
						.addBox(2.0F, -4.0F, -5.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(18, 0)
						.addBox(-2.0F, 2.0F, -7.0F, 4.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 14.0F, -3.0F));

		PartDefinition sleepeyes = head.addOrReplaceChild("sleepeyes", CubeListBuilder.create().texOffs(30, 23).addBox(
				-3.0F, -1.0F, 1.0F, 6.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 1.0F, -6.0F));
