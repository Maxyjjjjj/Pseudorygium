...
public class Modeljay<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "jay"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = body.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(20, 13)
						...
						.addBox(-1.0F, -0.5F, -6.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -4.0F, -4.0F, 0.48F, 0.0F, 0.0F));

		PartDefinition cube_r1 = head
				.addOrReplaceChild("cube_r1",
						CubeListBuilder.create().texOffs(20, 0).addBox(-1.5F, -3.5F, -1.0F, 3.0F, 2.0F, 3.0F,
								new CubeDeformation(0.0F)),
		...
		PartDefinition wingleft = partdefinition.addOrReplaceChild("wingleft",
				CubeListBuilder.create().texOffs(10, 18).addBox(0.0F, -1.0F, -1.0F, 1.0F, 5.0F, 8.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition wingleft2 = partdefinition.addOrReplaceChild("wingleft2",
				CubeListBuilder.create().texOffs(0, 13).addBox(-1.0F, -1.0F, -1.0F, 1.0F, 5.0F, 8.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0F, 15.0F, -1.0F, -0.3491F, 0.0F, 0.0F));
