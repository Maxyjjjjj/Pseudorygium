...
public class Modelshoebill<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "shoebill"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, 0.0F, -3.8507F, 6.0F, 6.0F, 9.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 11.0F, 0.0F, -0.2182F, 0.0F, 0.0F));

		PartDefinition head = body
				.addOrReplaceChild("head",
						CubeListBuilder.create().texOffs(22, 22).addBox(-1.0F, -5.0F, -1.0F, 2.0F, 5.0F, 2.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 2.0F, -3.5F, 0.2182F, 0.0F, 0.0F));

		PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(22, 16)
						.addBox(-1.0F, -6.0F, -4.75F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-0.5F, -6.0F, -5.0F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(11, 15)
						.addBox(-1.5F, -6.5F, -5.0F, 3.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(21, 0)
						.addBox(-1.5F, -7.0F, -1.0F, 3.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.3491F, 0.0F, 0.0F));

		PartDefinition cube_r2 = head
				.addOrReplaceChild("cube_r2",
						CubeListBuilder.create().texOffs(0, 29).addBox(-1.5F, -6.5F, 3.0F, 3.0F, 3.0F, 2.0F,
								new CubeDeformation(0.0F)),
