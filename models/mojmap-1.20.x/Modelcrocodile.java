...
public class Modelcrocodile<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "crocodile"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = body.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 51)
						.addBox(-3.5F, -1.0F, -6.0F, 7.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(36, 0)
						.addBox(-2.5F, -1.0F, -21.0F, 5.0F, 1.0F, 15.0F, new CubeDeformation(0.0F)).texOffs(46, 45)
						.addBox(-3.5F, -4.0F, -6.0F, 7.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(32, 31)
						.addBox(0.5F, -6.0F, -5.0F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(32, 26)
						.addBox(-3.5F, -6.0F, -5.0F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -2.0F, -10.0F));

		PartDefinition jaw = head.addOrReplaceChild("jaw", CubeListBuilder.create().texOffs(32, 26).addBox(-2.5F, -2.0F,
				-15.0F, 5.0F, 2.0F, 15.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -1.0F, -6.0F));
