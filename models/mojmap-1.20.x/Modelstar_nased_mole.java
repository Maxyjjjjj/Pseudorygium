...
public class Modelstar_nased_mole<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "star_nased_mole"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-3.0F, -6.0F, -5.0F, 6.0F, 6.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(0, 4)
						.addBox(-1.0F, -3.0F, -7.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-2.0F, -4.0F, -7.0F, 4.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition legleftback = partdefinition.addOrReplaceChild("legleftback", CubeListBuilder.create()
				.texOffs(17, 20).addBox(0.0F, -1.0F, -1.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(3.0F, 24.0F, 3.0F));

		PartDefinition cube_r3 = legleftback
				.addOrReplaceChild("cube_r3",
						CubeListBuilder.create().texOffs(8, 16).addBox(2.75F, -1.0F, -1.0F, 4.0F, 0.0F, 3.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.1309F));

		PartDefinition legrightback = partdefinition.addOrReplaceChild("legrightback", CubeListBuilder.create()
				.texOffs(8, 19).addBox(-3.0F, -1.0F, -1.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-3.0F, 24.0F, 3.0F));

		PartDefinition cube_r4 = legrightback
				.addOrReplaceChild("cube_r4",
						CubeListBuilder.create().texOffs(0, 16).addBox(-6.75F, -1.0F, -1.0F, 4.0F, 0.0F, 3.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.1309F));
