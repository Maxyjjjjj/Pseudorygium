...
public class Modelleaftailed_gecko<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "leaftailed_gecko"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = body.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 20)
						.addBox(-2.5F, -2.0F, -3.0F, 5.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(25, 15)
						.addBox(0.5F, -3.0F, -3.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(-0.5F)).texOffs(16, 20)
						.addBox(-3.5F, -3.0F, -3.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(-0.5F)).texOffs(20, 26)
						.addBox(-1.5F, -1.0F, -5.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, -4.0F));

		PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 8).addBox(-1.0F, -0.15F, 0.0F, 2.0F, 2.0F, 0.0F,
		...
		PartDefinition cube_r2 = tail.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, 0.0F, 0.0F, 6.0F, 0.0F, 10.0F,
		...
		PartDefinition legleftfront = partdefinition.addOrReplaceChild("legleftfront",
				CubeListBuilder.create().texOffs(10, 26)
						.addBox(0.0F, 0.0F, -1.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(19, 10)
						.addBox(3.0F, 2.0F, -2.5F, 4.0F, 0.0F, 5.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition legrightfront = partdefinition.addOrReplaceChild("legrightfront",
				CubeListBuilder.create().texOffs(0, 4)
						.addBox(-3.0F, 0.0F, -1.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(17, 0)
						.addBox(-7.0F, 2.0F, -2.5F, 4.0F, 0.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-2.0F, 22.0F, -2.0F));

		PartDefinition legrightback = partdefinition.addOrReplaceChild("legrightback",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-3.0F, 0.0F, -1.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(11, 10)
						.addBox(-7.0F, 2.0F, -2.5F, 4.0F, 0.0F, 5.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition legleftback = partdefinition.addOrReplaceChild("legleftback",
				CubeListBuilder.create().texOffs(0, 26)
						.addBox(0.0F, 0.0F, -1.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(17, 5)
						.addBox(3.0F, 2.0F, -2.5F, 4.0F, 0.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offset(2.0F, 22.0F, 3.0F));
