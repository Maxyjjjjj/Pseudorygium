...
public class Modelostrich<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(15, 28)
						.addBox(-2.0F, -13.0F, -10.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(44, 0)
						.addBox(-3.0F, -16.0F, -6.0F, 6.0F, 18.0F, 6.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition wingleft = partdefinition.addOrReplaceChild("wingleft",
				CubeListBuilder.create().texOffs(28, 28).addBox(0.0F, -2.0F, -1.0F, 1.0F, 8.0F, 13.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition wingleft2 = partdefinition.addOrReplaceChild("wingleft2",
				CubeListBuilder.create().texOffs(0, 28).addBox(-1.0F, -2.0F, -1.0F, 1.0F, 8.0F, 13.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-6.0F, 0.0F, -3.0F, -0.3054F, 0.0F, 0.0F));

		PartDefinition leg0 = partdefinition.addOrReplaceChild("leg0", CubeListBuilder.create().texOffs(16, 49).addBox(
				-2.0F, 0.0F, -2.0F, 4.0F, 16.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.5F, 8.0F, 1.0F));

		PartDefinition leg1 = partdefinition.addOrReplaceChild("leg1", CubeListBuilder.create().texOffs(0, 49).addBox(
				-2.0F, 0.0F, -2.0F, 4.0F, 16.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(2.5F, 8.0F, 1.0F));
