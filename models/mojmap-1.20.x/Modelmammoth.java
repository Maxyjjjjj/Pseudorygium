...
public class Modelmammoth<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "mammoth"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 66)
						.addBox(-11.0F, -11.0F, -17.0F, 22.0F, 22.0F, 34.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-11.5F, -11.5F, -16.75F, 23.0F, 32.0F, 34.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -8.0F, 0.0F));

		PartDefinition head = body.addOrReplaceChild("head", CubeListBuilder.create().texOffs(78, 66).addBox(-8.0F,
				-8.0F, -12.0F, 16.0F, 16.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -5.0F, -17.0F));

		PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(114, 29).addBox(16.5F, 2.0F, 16.0F, 4.0F, 16.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -1.5708F, 0.6981F, 0.0F));

		PartDefinition cube_r2 = head.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(112, 94).addBox(-20.5F, 2.0F, 16.0F, 4.0F, 16.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -1.5708F, -0.7418F, 0.0F));

		PartDefinition cube_r3 = head.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(112, 114).addBox(-3.5F, 11.0F, -5.0F, 4.0F, 16.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.6981F, -0.7418F, 0.0F));

		PartDefinition cube_r4 = head.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(0, 122).addBox(-0.5F, 11.0F, -5.0F, 4.0F, 16.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.6981F, 0.7418F, 0.0F));

		PartDefinition earleft = head.addOrReplaceChild("earleft", CubeListBuilder.create().texOffs(16, 122)
				.addBox(-1.0F, -6.0F, 0.0F, 12.0F, 11.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(9.0F, -3.0F, -5.0F));

		PartDefinition earright = head.addOrReplaceChild("earright", CubeListBuilder.create().texOffs(114, 49)
				.addBox(-13.0F, -6.0F, 0.0F, 12.0F, 12.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-7.0F, -3.0F, -5.0F));

		PartDefinition trunksegment1 = head.addOrReplaceChild("trunksegment1", CubeListBuilder.create().texOffs(84, 122)
				.addBox(-3.0F, -1.0F, -2.0F, 6.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)),
