...
public class Modelaardwolf<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "aardwolf"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(31, 0)
						.addBox(-3.0F, -5.0F, 0.0F, 6.0F, 9.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(1, 0)
						.addBox(-3.0F, -5.0F, -8.0F, 6.0F, 10.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(18, 19)
						.addBox(-2.0F, -7.0F, -8.25F, 4.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 11.0F, 0.0F));

		PartDefinition head = body.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(38, 19)
						.addBox(-2.0F, -3.0F, -5.0F, 4.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-1.0F, -1.0F, -7.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -5.0F, -8.25F));

		PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(26, 0).mirror()
						.addBox(-1.0F, -7.0F, -2.0F, 1.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.3491F, -0.48F));

		PartDefinition cube_r2 = head
				.addOrReplaceChild("cube_r2",
						CubeListBuilder.create().texOffs(26, 0).addBox(0.0F, -7.0F, -2.0F, 1.0F, 4.0F, 3.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.3491F, 0.48F));

		PartDefinition tail = body.addOrReplaceChild("tail",
				CubeListBuilder.create().texOffs(0, 19).addBox(-2.0F, 0.0F, 0.0F, 3.0F, 6.0F, 11.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition pawleftfront = partdefinition.addOrReplaceChild("pawleftfront", CubeListBuilder.create()
				.texOffs(0, 40).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition pawrightfront = partdefinition.addOrReplaceChild("pawrightfront",
				CubeListBuilder.create().texOffs(0, 40).mirror()
						.addBox(-1.0F, 0.0F, -1.0F, 2.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(-2.0F, 16.0F, -6.0F));

		PartDefinition pawrightback = partdefinition.addOrReplaceChild("pawrightback",
				CubeListBuilder.create().texOffs(20, 40).mirror()
						.addBox(-1.0F, 0.0F, -1.0F, 2.0F, 9.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition pawleftback = partdefinition.addOrReplaceChild("pawleftback", CubeListBuilder.create()
				.texOffs(20, 40).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 9.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(2.0F, 15.0F, 7.0F));
