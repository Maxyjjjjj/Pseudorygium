	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = body.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(19, 16)
						.addBox(-2.5F, -3.0F, -3.0F, 5.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 24)
						.addBox(1.0F, -5.0F, -1.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 8)
						.addBox(1.0F, -7.0F, -0.5F, 2.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(22, 6)
						.addBox(-3.0F, -5.0F, -1.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(6, 0)
		...
		PartDefinition tail = body
				.addOrReplaceChild("tail",
						CubeListBuilder.create().texOffs(0, 16).addBox(-2.0F, 0.0F, 0.0F, 4.0F, 4.0F, 11.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, -3.0F, 5.0F, -0.48F, 0.0F, 0.0F));
