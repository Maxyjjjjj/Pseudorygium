...
public class Modelpuma<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "puma"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = body.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(19, 27)
						.addBox(-3.0F, -3.0F, -6.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(37, 27)
						.addBox(2.0F, -5.0F, -5.0F, 1.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 36)
		...
		PartDefinition cube_r1 = head
				.addOrReplaceChild("cube_r1",
						CubeListBuilder.create().texOffs(0, 27).addBox(-1.5F, -2.0F, -2.0F, 3.0F, 2.0F, 3.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 2.0F, -6.0F, 0.2618F, 0.0F, 0.0F));

		PartDefinition jaw = head.addOrReplaceChild("jaw", CubeListBuilder.create(),
				PartPose.offset(0.0F, 2.0F, -6.0F));

		PartDefinition cube_r2 = jaw
				.addOrReplaceChild("cube_r2",
						CubeListBuilder.create().texOffs(0, 32).addBox(-1.5F, 0.0F, -2.0F, 3.0F, 1.0F, 3.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.2618F, 0.0F, 0.0F));

		PartDefinition tail = body.addOrReplaceChild("tail",
				CubeListBuilder.create().texOffs(0, 27).addBox(-1.0F, 1.0F, 2.0F, 2.0F, 2.0F, 15.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition pawleftfront = partdefinition.addOrReplaceChild("pawleftfront", CubeListBuilder.create()
				.texOffs(34, 0).addBox(-0.5F, -3.0F, -1.5F, 3.0F, 15.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition pawrightfront = partdefinition.addOrReplaceChild("pawrightfront", CubeListBuilder.create()
				.texOffs(0, 0).addBox(-2.5F, -3.0F, -1.5F, 3.0F, 15.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-2.0F, 12.0F, -7.0F));

		PartDefinition pawleftback = partdefinition.addOrReplaceChild("pawleftback", CubeListBuilder.create()
				.texOffs(0, 44).addBox(-0.5F, -2.0F, -1.5F, 3.0F, 14.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(2.0F, 12.0F, 7.0F));

		PartDefinition pawrightback = partdefinition.addOrReplaceChild("pawrightback", CubeListBuilder.create()
				.texOffs(34, 39).addBox(-2.5F, -2.0F, -1.5F, 3.0F, 14.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-2.0F, 12.0F, 7.0F));
