...
public class Modelcobra<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "cobra"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition tail2 = tail.addOrReplaceChild("tail2", CubeListBuilder.create().texOffs(15, 18).addBox(-1.0F,
				-2.0F, 0.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 5.0F));

		PartDefinition tail3 = tail2.addOrReplaceChild("tail3", CubeListBuilder.create().texOffs(8, 21).addBox(-0.5F,
		...
		PartDefinition neck = partdefinition.addOrReplaceChild("neck",
				CubeListBuilder.create().texOffs(0, 21)
						.addBox(-1.0F, -6.0F, -2.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(14, 12)
						.addBox(-4.0F, -6.0F, -1.0F, 8.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)),
