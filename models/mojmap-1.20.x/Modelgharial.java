...
public class Modelgharial<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "gharial"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0)
				.addBox(-4.0F, -6.0F, -10.0F, 8.0F, 6.0F, 20.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 20.0F, 0.0F));

		PartDefinition tail = body.addOrReplaceChild("tail", CubeListBuilder.create().texOffs(0, 26).addBox(-3.0F,
				-1.0F, 0.0F, 6.0F, 5.0F, 20.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -4.0F, 10.0F));

		PartDefinition head = body.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 51)
						.addBox(-3.5F, -1.0F, -6.0F, 7.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(32, 26)
						.addBox(-1.5F, -1.0F, -21.0F, 3.0F, 1.0F, 15.0F, new CubeDeformation(0.0F)).texOffs(46, 45)
						.addBox(-3.5F, -4.0F, -6.0F, 7.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(36, 0)
						.addBox(0.5F, -6.0F, -5.0F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(32, 32)
		...
		PartDefinition jaw = head.addOrReplaceChild("jaw",
				CubeListBuilder.create().texOffs(36, 0)
						.addBox(-1.5F, -2.0F, -12.0F, 3.0F, 2.0F, 12.0F, new CubeDeformation(0.0F)).texOffs(32, 26)
						.addBox(-2.0F, -3.0F, -15.0F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition legleftfront = partdefinition.addOrReplaceChild("legleftfront", CubeListBuilder.create()
				.texOffs(0, 36).addBox(-2.0F, -2.0F, -1.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(3.0F, 20.0F, -8.0F));

		PartDefinition legrightfront = partdefinition.addOrReplaceChild("legrightfront", CubeListBuilder.create()
				.texOffs(0, 26).addBox(-2.0F, -2.0F, -1.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-3.0F, 20.0F, -8.0F));

		PartDefinition legrightback = partdefinition.addOrReplaceChild("legrightback", CubeListBuilder.create()
				.texOffs(0, 10).addBox(-2.0F, -2.0F, -1.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-3.0F, 20.0F, 9.0F));

		PartDefinition legleftback = partdefinition.addOrReplaceChild("legleftback", CubeListBuilder.create()
				.texOffs(0, 0).addBox(-2.0F, -2.0F, -1.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(3.0F, 20.0F, 9.0F));
