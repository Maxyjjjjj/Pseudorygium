...
public class SlothEntity extends Animal {
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		SlothEntity retval = PseudorygiumModEntities.SLOTH.get().create(serverWorld);
	...
	public boolean isFood(ItemStack stack) {
		return Ingredient.of(ItemTags.create(ResourceLocation.parse("minecraft:leaves"))).test(stack);
	}
