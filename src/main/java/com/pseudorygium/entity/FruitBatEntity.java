...
public class FruitBatEntity extends Animal {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new RandomStrollGoal(this, 0.8, 20) {
			...
			protected Vec3 getPosition() {
				...
				double dir_x = FruitBatEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = FruitBatEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(PseudorygiumModEntities.FRUIT_BAT.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
