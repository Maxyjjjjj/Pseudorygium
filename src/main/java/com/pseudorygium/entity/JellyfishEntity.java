...
public class JellyfishEntity extends Animal {
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		JellyfishEntity retval = PseudorygiumModEntities.JELLYFISH.get().create(serverWorld, EntitySpawnReason.BREEDING);
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(PseudorygiumModEntities.JELLYFISH.get(), SpawnPlacementTypes.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
