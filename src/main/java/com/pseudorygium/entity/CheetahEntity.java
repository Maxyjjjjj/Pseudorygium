...
public class CheetahEntity extends Animal {
	...
	public SoundEvent getHurtSound(DamageSource ds) {
		return BuiltInRegistries.SOUND_EVENT.getValue(ResourceLocation.parse("entity.cat.hiss"));
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		CheetahEntity retval = PseudorygiumModEntities.CHEETAH.get().create(serverWorld, EntitySpawnReason.BREEDING);
