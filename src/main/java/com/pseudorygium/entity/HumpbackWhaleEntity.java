...
public class HumpbackWhaleEntity extends Animal {
	...
	public SoundEvent getAmbientSound() {
		return BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("pseudorygium:entity.whale.ambient"));
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		HumpbackWhaleEntity retval = PseudorygiumModEntities.HUMPBACK_WHALE.get().create(serverWorld);
