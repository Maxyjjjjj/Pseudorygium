...
public class BactrianCamelEntity extends TamableAnimal implements RangedAttackMob {
	...
	public void performRangedAttack(LivingEntity target, float flval) {
		CamelSpitEntity.shoot(this, target);
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(PseudorygiumModEntities.BACTRIAN_CAMEL.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
