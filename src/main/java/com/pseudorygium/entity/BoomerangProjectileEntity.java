...
public class BoomerangProjectileEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(PseudorygiumModItems.BOOMERANG.get());
	...
	public BoomerangProjectileEntity(EntityType<? extends BoomerangProjectileEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public BoomerangProjectileEntity(EntityType<? extends BoomerangProjectileEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	protected ItemStack getDefaultPickupItem() {
		return new ItemStack(PseudorygiumModItems.BOOMERANG.get());
	}
	...
	public static BoomerangProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		BoomerangProjectileEntity entityarrow = new BoomerangProjectileEntity(PseudorygiumModEntities.BOOMERANG_PROJECTILE.get(), entity, world, null);
	...
	public static BoomerangProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		BoomerangProjectileEntity entityarrow = new BoomerangProjectileEntity(PseudorygiumModEntities.BOOMERANG_PROJECTILE.get(), entity, entity.level(), null);
