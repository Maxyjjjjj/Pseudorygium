...
public class MooseEntity extends Animal {
	public MooseEntity(EntityType<MooseEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		MooseEntity retval = PseudorygiumModEntities.MOOSE.get().create(serverWorld);
	...
	public boolean isFood(ItemStack stack) {
		return Ingredient.of(new ItemStack(Items.BEETROOT), new ItemStack(Blocks.DANDELION), new ItemStack(Items.CARROT), new ItemStack(Blocks.SEAGRASS), new ItemStack(Blocks.KELP)).test(stack);
	}

	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(PseudorygiumModEntities.MOOSE.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
