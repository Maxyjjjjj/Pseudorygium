...
public class DeerEntity extends Animal {
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		DeerEntity retval = PseudorygiumModEntities.DEER.get().create(serverWorld);
	...
	public boolean isFood(ItemStack stack) {
		return Ingredient.of(new ItemStack(Blocks.SUGAR_CANE), new ItemStack(Items.WHEAT)).test(stack);
	}
