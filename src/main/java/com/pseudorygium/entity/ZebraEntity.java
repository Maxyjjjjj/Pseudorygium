...
public class ZebraEntity extends Animal {
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		ZebraEntity retval = PseudorygiumModEntities.ZEBRA.get().create(serverWorld, EntitySpawnReason.BREEDING);
	...
	public boolean isFood(ItemStack stack) {
		return Ingredient.of(Items.WHEAT, Items.GOLDEN_APPLE).test(stack);
	}
