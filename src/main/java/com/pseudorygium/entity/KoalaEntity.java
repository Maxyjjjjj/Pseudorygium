...
import com.pseudorygium.procedures.KoalaNaturalEntitySpawningConditionProcedure;
...
public class KoalaEntity extends Animal {
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		KoalaEntity retval = PseudorygiumModEntities.KOALA.get().create(serverWorld);
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(PseudorygiumModEntities.KOALA.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			...
			int y = pos.getY();
			int z = pos.getZ();
			return KoalaNaturalEntitySpawningConditionProcedure.execute(world, x, y, z);
