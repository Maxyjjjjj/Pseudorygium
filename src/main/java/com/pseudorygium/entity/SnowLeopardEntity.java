...
public class SnowLeopardEntity extends TamableAnimal {
	...
	public SoundEvent getAmbientSound() {
		return BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("pseudorygium:entity.snow_leopard.ambient"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
		return BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("pseudorygium:entity.snow_leopard.hurt"));
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		SnowLeopardEntity retval = PseudorygiumModEntities.SNOW_LEOPARD.get().create(serverWorld);
	...
	public boolean isFood(ItemStack stack) {
		return Ingredient.of(new ItemStack(Items.MUTTON)).test(stack);
	}
