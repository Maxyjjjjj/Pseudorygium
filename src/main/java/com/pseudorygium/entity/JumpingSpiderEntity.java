...
public class JumpingSpiderEntity extends Animal {
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, AphidEntity.class, false, false));
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		JumpingSpiderEntity retval = PseudorygiumModEntities.JUMPING_SPIDER.get().create(serverWorld, EntitySpawnReason.BREEDING);
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(PseudorygiumModEntities.JUMPING_SPIDER.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
