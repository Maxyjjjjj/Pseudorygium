...
public class SecretarybirdEntity extends Animal {
	public SecretarybirdEntity(EntityType<SecretarybirdEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(6, new NearestAttackableTargetGoal(this, HummingbirdEntity.class, false, false));
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		SecretarybirdEntity retval = PseudorygiumModEntities.SECRETARYBIRD.get().create(serverWorld);
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(PseudorygiumModEntities.SECRETARYBIRD.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
