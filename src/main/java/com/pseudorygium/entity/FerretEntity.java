...
public class FerretEntity extends TamableAnimal {
	public FerretEntity(EntityType<FerretEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		FerretEntity retval = PseudorygiumModEntities.FERRET.get().create(serverWorld);
	...
	public boolean isFood(ItemStack stack) {
		return Ingredient.of(new ItemStack(Items.CHICKEN), new ItemStack(Items.RABBIT)).test(stack);
	}

	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(PseudorygiumModEntities.FERRET.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
