...
public class FerretEntity extends TamableAnimal {
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		FerretEntity retval = PseudorygiumModEntities.FERRET.get().create(serverWorld, EntitySpawnReason.BREEDING);
	...
	public boolean isFood(ItemStack stack) {
		return Ingredient.of(Items.CHICKEN, Items.RABBIT).test(stack);
	}
