...
public class RegularBushBlock extends FlowerBlock {
	public RegularBushBlock(BlockBehaviour.Properties properties) {
	...
	public boolean mayPlaceOn(BlockState groundState, BlockGetter worldIn, BlockPos pos) {
		return groundState.is(Blocks.GRASS_BLOCK) || groundState.is(Blocks.SAND) || groundState.is(Blocks.RED_SAND);
	}
	...
	public static void blockColorLoad(RegisterColorHandlersEvent.Block event) {
		...
		}, PseudorygiumModBlocks.REGULAR_BUSH.get());
	}
}