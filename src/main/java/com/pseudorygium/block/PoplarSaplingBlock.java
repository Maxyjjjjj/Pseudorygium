...
import com.pseudorygium.procedures.PoplarSaplingUpdateTickProcedure;
import com.pseudorygium.procedures.PoplarSaplingPlantRightClickedProcedure;

public class PoplarSaplingBlock extends FlowerBlock {
	public PoplarSaplingBlock() {
	...
	public void randomTick(BlockState blockstate, ServerLevel world, BlockPos pos, RandomSource random) {
		PoplarSaplingUpdateTickProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ(), blockstate);
	}

	@Override
	public InteractionResult useWithoutItem(BlockState blockstate, Level world, BlockPos pos, Player entity, BlockHitResult hit) {
		super.useWithoutItem(blockstate, world, pos, entity, hit);
		PoplarSaplingPlantRightClickedProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ(), blockstate);
