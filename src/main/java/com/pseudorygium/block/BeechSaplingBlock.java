...
public class BeechSaplingBlock extends SaplingBlock {
	public static final TreeGrower TREE_GROWER = new TreeGrower("beech_sapling", Optional.empty(), Optional.of(getFeatureKey("pseudorygium:beech_tree")), Optional.empty());

	public BeechSaplingBlock(BlockBehaviour.Properties properties) {
