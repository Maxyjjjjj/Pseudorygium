...
import com.pseudorygium.procedures.BeechSaplingUpdateTickProcedure;
import com.pseudorygium.procedures.BeechSaplingRightClickedProcedure;
...
public class BeechSaplingBlock extends FlowerBlock {
	...
	public void randomTick(BlockState blockstate, ServerLevel world, BlockPos pos, RandomSource random) {
		BeechSaplingUpdateTickProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ(), blockstate);
	}

	@Override
	public InteractionResult useWithoutItem(BlockState blockstate, Level world, BlockPos pos, Player entity, BlockHitResult hit) {
		super.useWithoutItem(blockstate, world, pos, entity, hit);
		BeechSaplingRightClickedProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ(), blockstate);
