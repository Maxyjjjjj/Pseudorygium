...
import com.pseudorygium.procedures.WillowSaplingUpdateTickProcedure;
import com.pseudorygium.procedures.WillowSaplingPlantRightClickedProcedure;

public class WillowSaplingBlock extends FlowerBlock {
	...
	public void randomTick(BlockState blockstate, ServerLevel world, BlockPos pos, RandomSource random) {
		WillowSaplingUpdateTickProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ(), blockstate);
	}

	@Override
	public InteractionResult useWithoutItem(BlockState blockstate, Level world, BlockPos pos, Player entity, BlockHitResult hit) {
		super.useWithoutItem(blockstate, world, pos, entity, hit);
		WillowSaplingPlantRightClickedProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ(), blockstate);
