...
public class WillowSaplingBlock extends SaplingBlock {
	public static final TreeGrower TREE_GROWER = new TreeGrower("willow_sapling", Optional.empty(), Optional.of(getFeatureKey("pseudorygium:willow_tree")), Optional.empty());

	public WillowSaplingBlock(BlockBehaviour.Properties properties) {
