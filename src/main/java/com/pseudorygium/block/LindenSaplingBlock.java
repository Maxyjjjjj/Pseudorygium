...
import com.pseudorygium.procedures.LindenSaplingUpdateTickProcedure;
import com.pseudorygium.procedures.LindenSaplingPlantRightClickedProcedure;

public class LindenSaplingBlock extends FlowerBlock {
	public LindenSaplingBlock() {
	...
	public void randomTick(BlockState blockstate, ServerLevel world, BlockPos pos, RandomSource random) {
		LindenSaplingUpdateTickProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ(), blockstate);
	}

	@Override
	public InteractionResult useWithoutItem(BlockState blockstate, Level world, BlockPos pos, Player entity, BlockHitResult hit) {
		super.useWithoutItem(blockstate, world, pos, entity, hit);
		LindenSaplingPlantRightClickedProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ(), blockstate);
