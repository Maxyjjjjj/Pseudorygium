...
public class AspenSaplingBlock extends SaplingBlock {
	public static final TreeGrower TREE_GROWER = new TreeGrower("aspen_sapling", Optional.empty(), Optional.of(getFeatureKey("pseudorygium:aspen_tree")), Optional.empty());

	public AspenSaplingBlock(BlockBehaviour.Properties properties) {
