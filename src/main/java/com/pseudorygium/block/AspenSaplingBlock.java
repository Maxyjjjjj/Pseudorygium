...
import com.pseudorygium.procedures.AspenSaplingUpdateTickProcedure;
import com.pseudorygium.procedures.AspenSaplingRightClickedProcedure;

public class AspenSaplingBlock extends FlowerBlock {
	public AspenSaplingBlock() {
	...
	public void randomTick(BlockState blockstate, ServerLevel world, BlockPos pos, RandomSource random) {
		AspenSaplingUpdateTickProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ(), blockstate);
	}

	@Override
	public InteractionResult useWithoutItem(BlockState blockstate, Level world, BlockPos pos, Player entity, BlockHitResult hit) {
		super.useWithoutItem(blockstate, world, pos, entity, hit);
		AspenSaplingRightClickedProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ(), blockstate);
